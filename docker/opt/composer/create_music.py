...
def create_dog_melody(instruments_list):
    ...
    instruments_list : pretty_midi.Pretty_midi.instruments
        pretty_midi.Instrumentインスタンスを格納するリスト
    """
    guitar_flet_noise = pm.Instrument(Instruments.GUITAR_FRET_NOISE)
    ...
    append_notes(notes = guitar_flet_noise.notes, input_notes_list = dog_melody_notes_list)
    instruments_list.append(guitar_flet_noise)
